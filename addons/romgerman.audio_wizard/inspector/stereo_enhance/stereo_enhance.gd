...
const InspectorEditor := preload("res://addons/romgerman.audio_wizard/inspector/stereo_enhance/stereo_enhance_editor.tscn")

func _can_handle(object: Object) -> bool:
	return object is AudioEffectStereoEnhance
